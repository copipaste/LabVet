...
<template>
  <AdminLayout>
    ...
    <div class="max-w-2xl mx-auto p-6 bg-base-100 shadow-md rounded-box">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="mb-4">
          ...
          <input v-model="form.nombre" type="text" id="nombre" class="input input-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.especie" type="text" id="especie" class="input input-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.raza" type="text" id="raza" class="input input-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.edad" type="number" id="edad" min="0" class="input input-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <select v-model="form.sexo" id="sexo" class="select select-bordered w-full">
        ...
        <div class="mb-4">
          ...
          <select v-model="form.cliente_id" id="cliente_id" class="select select-bordered w-full">
