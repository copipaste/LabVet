    ...
    <div class="max-w-2xl mx-auto p-6 bg-base-100 shadow-md rounded-box">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="mb-4">
          ...
          <textarea v-model="form.descripcion" id="descripcion" class="textarea textarea-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.descuento" type="number" id="descuento" min="0" max="100" class="input input-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.fecha_inicio" type="date" id="fecha_inicio" class="input input-bordered w-full" />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.fecha_fin" type="date" id="fecha_fin" class="input input-bordered w-full" />
