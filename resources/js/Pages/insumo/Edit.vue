...
const form = useForm({
  ...
  cantidad_disponible: props.insumo.cantidad_disponible,
  unidad_medida: props.insumo.unidad_medida,
  fecha_caducidad: props.insumo.fecha_caducidad,
  tipo: props.insumo.tipo,
  categoria_id: props.insumo.categoria_id
})
...
<template>
  <AdminLayout>
    ...
    <div class="mb-6">
      <h1 class="text-3xl font-bold mb-2">Editar insumo</h1>
